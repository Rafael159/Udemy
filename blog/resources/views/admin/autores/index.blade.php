...
<modal nome="adicionar" titulo="Adicionar">
    <formulario id="formAdicionar" class="" action="{{route('autores.store')}}" method="post" enctype="" token="{{ csrf_token() }}">        
...
<modal nome="editar" titulo="Editar">    
    <formulario id="formEditar" class="" :action="'/admin/autores/' + $store.state.item.id" method="put" enctype="" token="{{ csrf_token() }}">        
        <div class="form-group">
            <label for="name">Nome</label>
